const SUPABASE_URL     = 'https://tulyfymvskuozntgsfzw.supabase.co';
  const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR1bHlmeW12c2t1b3pudGdzZnp3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE3Mjg2MzAsImV4cCI6MjA5NzMwNDYzMH0.NftBTkR_A8GCam3CooOoVtwwjrebbicsJYmBgPFVSdw';
  ...
  function showMaintenance(message) {
    document.title = 'Em manutenção - Libris Itaboraí';
  ...
  async function checkMaintenance() {
    try {
      ...
      // Se a tabela ainda não existir ou der erro, o site segue normalmente.
  ...
  async function viewSearch(rawQuery) {
    ...
    document.title = `Pesquisa: ${rawQuery} - Libris Itaboraí`;
